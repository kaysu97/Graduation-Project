                ...
                <div id="fh5co-services" style="min-height: 800px;">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="titles">應考證照 <input type="text" name="licensename" style="min-width: 100px; max-height: 25px;" required></div>
                            <br>
                            <div class="titles">考試年份
                            ...
                            <br>
                            <div class="hi">
                                <div class="titles">有無複試<span style="color:#fc0752; display:none" id="have">&nbsp;&nbsp;*&nbsp;此題為必填</span></div>
                                <input class="hidden radio-label" type="radio" name="stageYorN" value="有" id="yes" required/>
                                <label class="button-label" for="yes">
                                <p>有</p>
                                </label>
                                <input class="hidden radio-label" type="radio" name="stageYorN" value="無" id="no" />
                            ...
                            <br>
                            <div class="hi">
                                <h4>第一階段<span style="color:#fc0752; display:none; font-size:14px" id="have1">&nbsp;&nbsp;*&nbsp;此題為必填</span></h4>

                                <input class="hidden radio-label" type="radio" name="ExamType01" value="口試" id="oralflip" / required>
                                <label class="button-label" for="oralflip">
                                <p>口試</p>
                                </label>
                                <input class="hidden radio-label" type="radio" name="ExamType01" value="筆試" id="testflip" />
                                <label class="button-label" for="testflip">
                                <p>筆試</p>
                                </label>
                                <input class="hidden radio-label" type="radio" name="ExamType01" value="實作" id="doingflip" />
                            ...
                            <br>
                            <div class="hi">
                                <div class="titles">考試時間長度<span style="color:#fc0752; display:none" id="have2">&nbsp;&nbsp;*&nbsp;此題為必填</span></div>
                            ...
                            <div class="flex hide-on-small" id="oralpanel" style="display:none;">
                                <div class="hii">
                                    <div class="titles">考試內容補充</div>
                                    <div class="row">
                                        <div class="col-3">
                                            <input class="effect-4" type="text" name="oralquestion011" placeholder="可填寫題型、類別或難易度等等..">
                            ...
                            <div class="flex hide-on-small" id="textpanel" style="display:none;">
                                <div class="hii">
                                    <div class="titles">考試題型</div>
                                    <div class="row">
                                        <div class="col-3">
                                            <input class="effect-4" type="text" name="textquestion011" placeholder="旅遊類、時事類題型等等...">
                                            <span class="focus-border"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex hide-on-small" id="doingpanel" style="display:none;">
                                <div class="hii">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <input class="effect-4" type="text" name="practicequestion011" placeholder="主題、題目等等...">
                                            <span class="focus-border"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="stage2" style="display: none;">
                                <div class="hi">
                                    <h4>第二階段</h4>
                                    <input class="hidden radio-label" type="radio" name="ExamType02" value="口試" id="oralflip2" />
                                    <label class="button-label" for="oralflip2">
                                <p>口試</p>
                                </label>
                                    <input class="hidden radio-label" type="radio" name="ExamType02" value="筆試" id="testflip2" />
                                    <label class="button-label" for="testflip2">
                                <p>筆試</p>
                                </label>
                                    <input class="hidden radio-label" type="radio" name="ExamType02" value="實作" id="doingflip2" />
                                ...
                                <div class="flex hide-on-small" id="oralpanel2" style="display:none;">
                                    <div class="hii">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <input class="effect-4" type="text" name="oralquestion021" placeholder="可填寫題型、類別或難易度等等..">
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex hide-on-small" id="textpanel2" style="display:none;">
                                    <div class="hii">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <input class="effect-4" type="text" name="textquestion021" placeholder="旅遊類、時事類題型等等...">
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex hide-on-small" id="doingpanel2" style="display:none;">
                                    <div class="hii">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <input class="effect-4" type="text" name="practicequestion021" placeholder="主題、題目等等...">
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                                    </div>
