                ...
                <div id="fh5co-services" style="min-height: 800px;">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="titles" style="display: inline;"><span style="color:#fc0752;">*&nbsp;</span>應考證照</div>
                            <br>
                               <!-- <input type="text" name="licensename" style="min-width: 100px; max-height: 25px;" required> -->

                               <div class="search-box" style="display: inline;">
                               <input type="text" name="licensename" style="border: none; border-bottom: 2px solid #ebedef; width: 400px; padding: 5px 10px;" autocomplete="off" required>
                            ...
                            <br>
                            <div class="hi">
                                <div class="titles"><span id="sign" style="color:#fc0752;">*&nbsp;</span>報名方式</div>
                            ...
                            <div class="titles"><span style="color:#fc0752;">*&nbsp;</span>準備時間:&nbsp;從&nbsp;
                                <input type="text" style="width:50px;height:25px" name="preparedtime" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,‘‘)" 
required>&nbsp;個月前開始，平均一周&nbsp;<input type="text" style="width:50px;height:25px" name="preparedhour" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,‘‘)" required>&nbsp;小時 </div>
                            <br>

                            <div class="titles"><span style="color:#fc0752;">*&nbsp;</span>是否參加補習班<br>
                            ...
                            <br><br>
                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;推薦用書</div><br>
                            ...
                            <br><br>
                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;其他資源</div><br>
                            ...
                            <br><br>
                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;備註</div><br>
                            <textarea style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;" name="ps" placeholder="例如：準備訣竅..等等"></textarea>
                            <br><br>
