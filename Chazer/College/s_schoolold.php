        ...
        <form action="collegesubmit.php" method="post">
            <div class="rela-block profile-card">
                <div id="fh5co-services" style="min-height: 800px;">
                  ...
                  <option value="">請選擇面試科系</option>
                            ...
                            <div class="titles">級分
                                <select class="selectpicker" data-size="10" style="width:50px;" name="Score">
                                  <option>0</option>
                                  <option>1</option>
                                  <option>2</option>
                                  <option>3</option>
              ...
              <input type="radio" name="Admitted" value="無">無
                            ...
                            <div class="titles">面試年份
                                <select class="selectpicker" data-size="10" style="width:80px;" name="InterviewDate">
                                <option>1999</option>
                                <option>2000</option>
                                <option>2001</option>
                                <option>2002</option>
            ...
            <input type="radio" class="btn btn-item" name="Application" value="無">無
                            ...
                            <div class="hi">
                                ...
                                <input class="hidden radio-label" type="radio" name="InterviewType01" value="面試" id="oralflip" />
            ...
            <br><br> -->
                            <div class="flex hide-on-small" id="oralpanel" style="display:none;">
                                <div class="hi">
                                    ...
                                    <input class="hidden radio-label" type="radio" value="1" name="InterviewerNumber01" id="1p" checked="checked" />
                                ...
                                <div class="hi">
                                    ...
                                    <input class="hidden radio-label" type="radio" value="個人" name="IntervieweeNumber01" id="self" checked="checked" />
                                ...
                                <div class="hi">
                                    ...
                                    <input class="hidden radio-label" type="radio" value="5分鐘以內" name="InterviewDuration01" id="5min" checked="checked" />
                                ...
                                <div class="hii">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea rows="2" name="oralquestion011" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#2ECC71;"></textarea>
                                        </div>
                                        <div class="col-1">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea rows="2" name="oralanswer011" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                        </div>
                                    </div>
                                    <div class="newq" id="or_new1" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralquestion012" style="width:100%;height:100px; border-color:#2ECC71;" placeholder="例如：為什麼要申請我們學校？"></textarea>
                                            </div>
                                        </div>
                                        <div class="titles">答案</div>
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralanswer012" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                            </div>
          ...
          <div class="titles">個人回答：<input type="text" style="min-width: 450px;" name="oralanswer011"></div>
                            ...
                            <div class="flex hide-on-small" id="textpanel" style="display:none;">
                                ...
                                <div class="hi">
                                    ...
                                    <input class="hidden radio-label" type="checkbox" id="toggle5" name="QuestionType01[]" value="單選" data-rule="checked" checked>
                                    <label class="button-label" for="toggle5">單選</label>

                                    <input class="hidden radio-label" type="checkbox" id="toggle6" name="QuestionType01[]" value="多選ˇ">
                                ...
                                <div class="hii">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea rows="2" name="Question011" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#2ECC71;"></textarea>
                                        </div>
                                        <div class="col-1">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea rows="2" name="PersonalAnswer011" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                        </div>
                                    </div>
                                    <div class="newq" id="te_new1" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="Question012" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#2ECC71;"></textarea>
                                            </div>
                                        </div>
                                        <div class="titles">答案</div>
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="PersonalAnswer012" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                            </div>
                            ...
                            <div class="flex hide-on-small" id="doingpanel" style="display:none;">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <textarea row="2" name="SpecialRequirement01" placeholder="例如：需不需要穿正裝？" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <br><br>
                            <div id="stage2">
                                ...
                                <div class="flex hide-on-small" id="oralpanel1" style="display:none;">
                                    ...
                                    <div class="hii">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralquestion021" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#2ECC71;"></textarea>
                                            </div>
                                            <div class="col-1">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralanswer021" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                            </div>
                                        </div>
                                        <div class="newq" id="or_new" style="display: none;">
                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea rows="2" name="oralquestion022" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#2ECC71;"></textarea>
                                                </div>
                                            </div>
                                            <div class="titles">答案</div>
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea rows="2" name="oralanswer022" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex hide-on-small" id="textpanel1" style="display:none;">
                                    ...
                                    <div class="hi">
                                        <div class="titles">題型</div>
                                        <input class="hidden radio-label" type="checkbox" id="toggle1" name="QuestionType02[]" value="單選" data-rule="checked" checked>
                                        <label class="button-label" for="toggle1">單選</label>

                                        <input class="hidden radio-label" type="checkbox" id="toggle2" name="QuestionType02[]" value="多選ˇ">
                                    ...
                                    <div class="hii">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="Question021" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#2ECC71;"></textarea>
                                            </div>
                                            <div class="col-1">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="PersonalAnswer021" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                            </div>
                                        </div>
                                        <div class="newq" id="newq" style="display: none;">
                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea rows="2" name="Question022" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#2ECC71;"></textarea>
                                                </div>
                                            </div>
                                            <div class="titles">答案</div>
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea rows="2" name="PersonalAnswer022" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex hide-on-small" id="doingpanel1" style="display:none;">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea row="2" name="SpecialRequirement02" placeholder="例如：需不需要穿正裝？" style="width:100%;height:100px; border-color:#2ECC71;"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <textarea row="2" name="PersonalOpinion" style="width:50%;height:100px; border-color:#2ECC71;"></textarea>
                            <br>
