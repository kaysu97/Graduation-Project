...
?>
  ...
  ?>
                ...
                ?>
                                ...
                                <div class="col-md-10 col-sm-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-1 ">
                                            <div class="card">
                                               <div class="p" style="width: 200px; height: 150px; font-size: 30px; color: black; text-align: center; border: 3px solid black; padding-top: 50px;">COLLEGE</div>
                                            </div>
                                        </div>

                                        <div class="col-md-4 col-sm-4">
                                            <div class="p" style="font-family:Microsoft JhengHei; font-size: 1.2em;color: #333; padding: 5px 0; padding-top: 80px; letter-spacing: 2px;">文章編號：
                                                <?php echo $uploader['id']; ?>
                                            </div>
                                            <div class="p" style="font-family:Microsoft JhengHei; font-size: 1.2em;color: #333; padding: 5px 0;letter-spacing: 2px;">
                                                <?php echo '<a href ='.$college['CollegeLink'].'> '.$uploader['CollegeName'].'</a>'; ?></div>
                                            <div class="p" style="font-family:Microsoft JhengHei; font-size: 1.2em;color: #333; padding: 5px 0;letter-spacing: 2px;　">
                                                <?php echo '<a href ='.$department['DepartmentLink'].'> '.$uploader['CollegeDepartment'].'</a>'; ?></div>
                                            <div class="p" style="font-family:Microsoft JhengHei; font-size: 1.2em;color: #333; padding: 5px 0;letter-spacing: 2px;　">發文者：
                                                <?php echo $pouser['name']; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-4">
                                            <div class="p" style="font-family:Microsoft JhengHei; font-size: 1.2em;color: #333; padding: 5px 0; padding-top: 80px;letter-spacing: 2px;　">年份：
                                                <?php echo $uploader['InterviewDate']; ?>
                                            </div>
                                            <div class="p" style="font-family:Microsoft JhengHei; font-size: 1.2em;color: #333; padding: 5px 0;letter-spacing: 2px;　">級數：
                                                <?php echo $uploader['Score']; ?>
                                            </div>
                                            <div class="p" style="font-family:Microsoft JhengHei; font-size: 1.2em;color: #333; padding: 5px 0;letter-spacing: 2px;　">備審資料：
                                                <?php echo $uploader['Application']; ?>
                                            </div>
                    ...
                    ?>
                                                            <p style="white-space:nowrap; padding-top: 10px;">發表時間
                                                                <?php echo $newdate; ?>
                                                            </p>
                                                    </td>
                    ...
                    ?>
                      ...
                      if($n == $email){
                        echo '
                        <br>
                              <a href="school-2-edit.php?id='.$articleid.'" class="button" style="font-size:0.8em; width:5em; padding: 5px; color: #605f5f; letter-spacing:2px; font-weight:400; text-align: center; margin-left:5px;">EDIT</a>
                              <a href="deletecollege.php?id='.$articleid.'" class="button confirmation" style="font-size:0.8em; width:6em; padding: 5px; color: #605f5f; letter-spacing:2px; font-weight:400; text-align: center; margin-left:40px;">DELETE</a>
                             ';
                      }
                 ?>
                  </tr>
              ...
              if($uploader['InterviewType01']=='筆試'){
                if($uploader['PersonalAnswer011']!=''){
                  echo 'A：'.$uploader['PersonalAnswer011'];
                }
              }
              ?>
              ...
              if($uploader['InterviewType01']=='面試'){
                if($uploader['oralquestion012']!=''){
                  echo '<hr style="border:0.4px dashed black" size="0.8" width="97%">';
                }
              }
              if($uploader['InterviewType01']=='筆試'){
              ...
              ?>
                            ...
                            <br>
                            <?php
      if(!empty($uploader['InterviewType02'])){
        ?>
                                <div class="row">
                                    <div class="col-md-1" style="width:8.33%; float: left;!improtant"></div>
                                    <div class="col-md-10" style="background-color: #f6f6f6; padding: 30px 20px;">
                ...
                ?>
                                ...
                                <?php }?>
                                <br>
                                <?php  if(!empty($uploader['PersonalOpinion'])) {?>
                                <div class="row">
                                    <div class="col-md-1" style="width:8.33%; float: left;!improtant"></div>
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li id="hide">
                                                        <a href="#add-comment" role="tab" data-toggle="tab">
                                                            <h4 id="leavecomment" class="reviews text-capitalize">Add comment</h4>
                                                        </a>
                                                    </li>
                                                </ul>
