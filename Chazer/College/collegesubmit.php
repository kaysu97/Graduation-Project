...
// $stmt = $conn->prepare("INSERT INTO collegearticle(CollegeName, CollegeDepartment, InterviewDate, Score, Application, Admitted, InterviewType01, InterviewerNumber01,
//  IntervieweeNumber01, InterviewDuration01, oralquestion011, oralanswer011, QuestionType01, Question011, PersonalAnswer011,
// SpecialRequirement01, InterviewType02, InterviewerNumber02, IntervieweeNumber02, InterviewDuration02, oralquestion021, oralanswer021, QuestionType02, Question021, PersonalAnswer021, SpecialRequirement02, PersonalOpinion,uploadtime,user)
// VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),?)");
// $stmt->bind_param("ssssssssssssssssssssssssssss",$CollegeNameSelected,$CollegeDepartmentSelected,$InterviewDate,$Score,$Application,$Admitted,$InterviewType01,$InterviewerNumber01,$IntervieweeNumber01,$InterviewDuration01,$oralquestion011,$oralanswer011,$QuestionType01,$Question011,$PersonalAnswer011,$SpecialRequirement01,$InterviewType02,$InterviewerNumber02,$IntervieweeNumber02,$InterviewDuration02,$oralquestion021,$oralanswer021,$QuestionType02,$Question021,$PersonalAnswer021,$SpecialRequirement02,$PersonalOpinion,$user);
$stmt = $conn->prepare("INSERT INTO collegearticle(CollegeName, CollegeDepartment, InterviewDate, Score, Application, Admitted, InterviewType01, InterviewerNumber01,
  IntervieweeNumber01, InterviewDuration01, oralquestion011, oralanswer011, oralquestion012, oralanswer012, QuestionType01, Question011,
  Question012, PersonalAnswer011, PersonalAnswer012, SpecialRequirement01, InterviewType02, InterviewerNumber02, IntervieweeNumber02, InterviewDuration02, oralquestion021, oralanswer021, oralquestion022, oralanswer022, QuestionType02, Question021, PersonalAnswer021, Question022, PersonalAnswer022, SpecialRequirement02, PersonalOpinion,uploadtime,user)
  VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),?)");
  $stmt->bind_param("ssssssssssssssssssssssssssssssssssss",$CollegeNameSelected,$CollegeDepartmentSelected,$InterviewDate,$Score,$Application,$Admitted,$InterviewType01,
  $InterviewerNumber01,$IntervieweeNumber01,$InterviewDuration01,$oralquestion011,$oralanswer011,$oralquestion012,$oralanswer012,$QuestionType01,$Question011,$Question012,$PersonalAnswer011,
  $PersonalAnswer012,$SpecialRequirement01,$InterviewType02,$InterviewerNumber02,$IntervieweeNumber02,$InterviewDuration02,$oralquestion021,$oralanswer021,$oralquestion022,$oralanswer022,$QuestionType02,$Question021,$PersonalAnswer021,$Question022,$PersonalAnswer022,$SpecialRequirement02,$PersonalOpinion,$user);
