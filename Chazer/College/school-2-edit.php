  ...
  // echo $articleid;
  $query = $conn->query("SELECT * FROM collegearticle WHERE user = '$poemail' and id = '$articleid'");
...
<style type="text/css">
  ...
  <body>
      <div id="page">
          ...
          <form action="school-2-edit-submit.php" method="post">
              <div class="rela-block profile-card">
                  <div id="fh5co-services" style="min-height: 800px;">
                    ...
                    <?php
                    echo '<option>'.$po['CollegeName'].'</option>';
                    ...
                    ?>
                              ...
                              <div class="titles"><span style="color:#fc0752;">*&nbsp;</span>面試科系
                                  ...
                                  <?php
                                  echo '<option>'.$po['CollegeDepartment'].'</option>';
                                  ?>
                              ...
                              <div class="titles">級分
                                  <select class="selectpicker" data-size="10" style="width:60px;" name="Score">
                                    <option disabled selected hidden value="">級分</option>
                                    <?php
                                    echo '<option selected>'.$po['Score'].'</option>';
                                    ?>
                                    <option>0</option>
                                    <option>1</option>
                                    <option>2</option>
                              ...
                              <div class="hi">
                                  ...
                                  if($po['Admitted']=='正取'){
                                    echo '
                                    <input class="hidden radio-label" checked="checked" type="radio" name="Admitted" id="in" value="正取" />
                                  ...
                                  if($po['Admitted']=='備取'){
                                    echo '
                                    <input class="hidden radio-label" checked="checked" type="radio" name="Admitted" id="waiting" value="備取" />
                                  ...
                                  if($po['Admitted']=='無'){
                                    echo '
                                    <input class="hidden radio-label" checked="checked" type="radio" name="Admitted" id="no_in" value="無" />
                ...
                <input type="radio" name="Admitted" value="無">無
                              ...
                              <div class="titles"><span style="color:#fc0752;">*&nbsp;</span>面試年份
                                  ...
                                  <?php
                                  echo '<option selected>'.$po['InterviewDate'].'</option>';
                                  ?>
                                  <option>1999</option>
                                  <option>2000</option>
                                  <option>2001</option>
                              ...
                              <div class="hi">
                                  ...
                                  <?php
                                        if($po['Application']=='制式'){
                                          echo '
                                          <input class="hidden radio-label" type="radio" checked="checked" name="Application" id="yes-button" value="制式" required/>
                                        ...
                                        if($po['Application']=='自製'){
                                          echo '
                                          <input class="hidden radio-label" type="radio" checked="checked" name="Application" value="自製" id="no-button" />
                                        ...
                                        if($po['Application']=='無'){
                                          echo '
                                          <input class="hidden radio-label" type="radio" checked="checked" name="Application" value="無" id="maybe-button" />
                              ...
                              <div class="hi">
                                  ...
                                  <?php
                                  if($po['InterviewType01']=='面試'){
                                    echo '
                                    <input class="hidden radio-label" type="radio" checked="checked" name="InterviewType01" value="面試" id="oralflip" required />
                                  ...
                                  if($po['InterviewType01']=='筆試'){
                                    echo '
                                    <input class="hidden radio-label" type="radio" checked="checked" name="InterviewType01" value="筆試" id="testflip"/>
                                  ...
                                  if($po['InterviewType01']=='參訪'){
                                    echo '
                                    <input class="hidden radio-label" type="radio" checked="checked" name="InterviewType01" value="參訪" id="doingflip" />
                              ...
                              <div class="flex hide-on-small" id="oralpanel" style="display:none;">
                                  <div class="hi">
                                      ...
                                      <?php
                                            if($po['InterviewerNumber01']=='1'){
                                              echo '
                                              <input class="hidden radio-label" checked type="radio" value="1" name="InterviewerNumber01" id="1p" />
                                              ...
                                              ';
                                            }elseif ($po['InterviewerNumber01']=='2') {
                                              echo '
                                              <input class="hidden radio-label" type="radio" value="1" name="InterviewerNumber01" id="1p" />
                                              <label class="button-label" for="1p">
                                                <p>1人</p>
                                              </label>
                                              <input class="hidden radio-label" checked type="radio" value="2" name="InterviewerNumber01" id="2p" />
                                              <label class="button-label" for="2p">
                                                <p>2人</p>
                                              </label>
                                              <input class="hidden radio-label" type="radio" value="3" name="InterviewerNumber01" id="3p" />
                                              ...
                                              ';
                                            }elseif ($po['InterviewerNumber01']=='3') {
                                              echo '
                                              <input class="hidden radio-label" type="radio" value="1" name="InterviewerNumber01" id="1p" />
                                              <label class="button-label" for="1p">
                                                <p>1人</p>
                                              ...
                                              <input class="hidden radio-label" checked type="radio" value="3" name="InterviewerNumber01" id="3p" />
                                              <label class="button-label" for="3p">
                                                <p>3人</p>
                                              </label>
                                              <input class="hidden radio-label" type="radio" value="4" name="InterviewerNumber01" id="4p" />
                                              ...
                                              ';
                                            }elseif ($po['InterviewerNumber01']=='4') {
                                              echo '
                                              <input class="hidden radio-label" type="radio" value="1" name="InterviewerNumber01" id="1p" />
                                              <label class="button-label" for="1p">
                                                <p>1人</p>
                                              ...
                                              <input class="hidden radio-label" checked type="radio" value="4" name="InterviewerNumber01" id="4p" />
                                              <label class="button-label" for="4p">
                                                <p>4人</p>
                                              </label>
                                              <input class="hidden radio-label" type="radio" value="5" name="InterviewerNumber01" id="5p" />
                                              ...
                                              ';
                                            }elseif ($po['InterviewerNumber01']=='5') {
                                              echo '
                                              <input class="hidden radio-label" type="radio" value="1" name="InterviewerNumber01" id="1p" />
                                              <label class="button-label" for="1p">
                                                <p>1人</p>
                                              ...
                                              <input class="hidden radio-label" checked type="radio" value="5" name="InterviewerNumber01" id="5p" />
                                              <label class="button-label" for="5p">
                                                <p>5人或以上</p>
                                              </label>
                                              ';
                                  ...
                                  <div class="hi">
                                      ...
                                      <?php
                                            if($po['IntervieweeNumber01']=='個人'){
                                              echo '
                                              <input class="hidden radio-label" checked type="radio" value="個人" name="IntervieweeNumber01" id="self" />
                                            ...
                                            if($po['IntervieweeNumber01']=='團體'){
                                              echo '
                                              <input class="hidden radio-label" checked type="radio" value="團體" name="IntervieweeNumber01" id="group" />
                                  ...
                                  <div class="hi">
                                      ...
                                      <?php
                                      if($po['InterviewDuration01']=='5分鐘'){
                                        echo '
                                        <input class="hidden radio-label" checked type="radio" value="5分鐘以內" name="InterviewDuration01" id="5min" checked/>
                                      ...
                                      if($po['InterviewDuration01']=='15分鐘以內'){
                                        echo '
                                        <input class="hidden radio-label" checked type="radio" value="15分鐘以內" name="InterviewDuration01" id="15min" checked/>
                                      ...
                                      if($po['InterviewDuration01']=='30分鐘以內'){
                                        echo '
                                        <input class="hidden radio-label" checked type="radio" value="30分鐘以內" name="InterviewDuration01" id="30min" checked/>
                                  ...
                                  <div class="hii">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea rows="2" name="oralquestion011" placeholder="例如：為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                        </div>
                                        <div class="col-1">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea rows="2" name="oralanswer011" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                        </div>
                                    </div>
                                    <div class="newq" id="or_new1" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralquestion012" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;" placeholder="例如：為什麼要申請我們學校？"></textarea>
                                            </div>
                                        </div>
                                        <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;答案</div>
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralanswer012" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                            </div>
                              ...
                              <div class="flex hide-on-small" id="textpanel" style="display:none;">
                                  <br>
                                  <div class="hi">
                                      <div class="titles"><span style="color:#fc0752;">*&nbsp;</span>題型</div>
                                  ...
                                  <div class="hii">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea id="TQ1" rows="2" name="Question011" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                        </div>
                                        <div class="col-1">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <textarea rows="2" name="PersonalAnswer011" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;;"></textarea>
                                        </div>
                                    </div>
                                    <div class="newq" id="te_new1" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea id="TQ2" rows="2" name="Question012" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                            </div>
                                        </div>
                                        <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;答案</div>
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="PersonalAnswer012" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                            </div>
                              ...
                              <div class="flex hide-on-small" id="doingpanel" style="display:none;">
                                  ...
                                  <div class="row">
                                      <div class="col-3">
                                        <?php
                                            if($po['SpecialRequirement01']!=''){
                                              echo '
                                              <textarea row="2" name="SpecialRequirement01" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;">'.$po['SpecialRequirement01'].'</textarea>
                                              ';
                                            }else{
                                              echo '
                                              <textarea row="2" name="SpecialRequirement01" placeholder="例如：需不需要穿正裝？" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                              ';
                                            }
                                         ?>
                                      </div>
                              ...
                              <div id="stage2">
                                  ...
                                  <div class="flex hide-on-small" id="oralpanel1" style="display:none;">
                                      ...
                                      <div class="hii">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralquestion021" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                            </div>
                                            <div class="col-1">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="oralanswer021" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                            </div>
                                        </div>
                                        <div class="newq" id="or_new" style="display: none;">
                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea rows="2" name="oralquestion022" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                                </div>
                                            </div>
                                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;答案</div>
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea rows="2" name="oralanswer022" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div class="flex hide-on-small" id="textpanel1" style="display:none;">
                                      ...
                                      <div class="hii">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea id="TQ01" rows="2" name="Question021" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                            </div>
                                            <div class="col-1">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <textarea rows="2" name="PersonalAnswer021" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                            </div>
                                        </div>
                                        <div class="newq" id="newq" style="display: none;">
                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea id="TQ02" rows="2" name="Question022" placeholder="eg.為什麼申請我們學校?" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                                </div>
                                            </div>
                                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;答案</div>
                                            <div class="row">
                                                <div class="col-3">
                                                    <textarea rows="2" name="PersonalAnswer022" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div class="flex hide-on-small" id="doingpanel1" style="display:none;">
                                      ...
                                      <div class="row">
                                          <div class="col-3">
                                              <textarea row="2" name="SpecialRequirement02" placeholder="例如：需不需要穿正裝？" style="width:100%;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <?php
                                  if($po['PersonalOpinion']!=''){
                                    echo '
                                    <textarea row="2" name="PersonalOpinion" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;">'.$po['PersonalOpinion'].'</textarea>
                                    ';
                                  }
                                  else{
                                    echo '
                                    <textarea row="2" name="PersonalOpinion" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                    ';
                                  }
                               ?>
                              <br><br>
