    ...
    <script>
        function setRequired2() {
            ...
            if (document.getElementById("yess").checked == true) {
                ...
                document.getElementById("under5").setAttribute("required", "required");
                if (document.getElementById("under5").checked != true && document.getElementById("5to10").checked != true && document.getElementById("above10").checked != true) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="search-box">
                                ...
                                <input type="text" autocomplete="off" name="CompanyNameSelected" placeholder="Search company..." required style="border: none; border-bottom: 2px solid #ebedef; width: 400px;padding: 5px 10px;height: 50px;">
                                <div class="result"></div>
                            </div><br><br>
                            <div class="titles"><span style="color:#fc0752;">*&nbsp;</span>部門</div>
                                <input type="text" name="department" style="border: none; border-bottom: 2px solid #ebedef; width: 400px; padding: 5px 10px;" required>
                            <br><br>
                            <div class="hi">
                            ...
                            <hr class="style9">
                            <br>
                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;工作上的困難</div><br> <textarea rows="2" name="obstacle" style="width:100% ;height:100px; border-color:#7e7c7c;"></textarea><br><br>
                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;工作福利</div><br> <textarea rows="2" name="welfare" style="width:100% ;height:100px; border-color:#7e7c7c;"></textarea><br><br>
                            <div class="title" style="font-size=1.2em; font-weight=400;">&nbsp;&nbsp;想說的話</div><br>
                            <textarea row="2" name="personalopinion" style="width:100% ;height:100px; border-color:#7e7c7c;"></textarea><br><br>
