...
$query = $conn->query("SELECT * FROM companyarticle WHERE user = '$poemail' and id = '$articleid'");
...
<style type="text/css">
    ...
    <body>
        <div id="page">
            ...
            <form action="company-2-edit-submit.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="search-box">
                                    ...
                                    <input type="text" autocomplete="off" value="<?php echo $po['CompanyNameSelected'] ?>" name="CompanyNameSelected" required style="border: none; border-bottom: 2px solid #ebedef; width: 400px; height: 50px;">
                                    <div class="result"></div>
                                </div>
                                <br><br>
                                <div class="titles">應徵部門</div>
                                <input type="text" name="applydepartment" value="<?php echo $po['applydepartment'] ?>"  style="border: none; border-bottom: 2px solid #ebedef; width: 400px;padding: 5px 10px;" placeholder="公關、行銷" required>
                                <br><br>
                                <div class="titles">面試年分
                                <select class="selectpicker" data-size="10" style="min-width: 15%" name="interviewDate" id="datepicker" required>
                <option disabled selected hidden>請選擇面試時間</option>
                <?php
                ...
                ?>
                                ...
                                <div class="hi">
                                    ...
                                    <input class="hidden radio-label" type="radio" id="portfolioY" name="portfolio" value="是" required onchange="setRequired1()">
                  ...
                  <p>否</p>
                                ...
                                <div class="hi">
                                    ...
                                    <input class="hidden radio-label" type="radio" id="certificationY" name="certification" value="是" required onchange="setRequired2()">
                ...
                <p>面試</p>
                                ...
                                <div class="flex hide-on-small" id="interviewpanel" style="display: none;"><br>
                                    ...
                                    <div class="titles"><span style="color:#fc0752; font-size:14px">*&nbsp;</span>面試官人數 &shy;
                                        <input type="number" name="interviewerNumber" min="1" max="10">
                                    </div><br>
                                    <div class="hi">
                              ...
                              <p>60分鐘以上</p></label>
                                ...
                                <div id="testpanel" style="display: none;">
                                    <div class="hi">
                                        ...
                                        <input class="hidden radio-label" type="checkbox" id="test1" name="testlevel[]" value="一">
                                    ...
                                    <div class="hi">
                                        ...
                                        <input class="hidden radio-label" type="checkbox" id="testType1" name="testQType[]" value="單選">
                                        <label class="button-label" for="testType1">單選</label>

                                        <input class="hidden radio-label" type="checkbox" id="testType2" name="testQType[]" value="複選">
                                        <label class="button-label" for="testType2">複選</label>

                                        <input class="hidden radio-label" type="checkbox" id="testType3" name="testQType[]" value="填空">
                                        <label class="button-label" for="testType3">填空</label>

                                        <input class="hidden radio-label" type="checkbox" id="testType4" name="testQType[]" value="簡答">
                                        <label class="button-label" for="testType4">簡答</label>

                                        <input class="hidden radio-label" type="checkbox" id="testType5" name="testQType[]" value="申論">
                                ...
                                <div id="otherpanel" style="display:none;">
                                    <div class="row">
                                        <div class="col-3" style="padding-bottom: 0;">
                                            <p><span style="color:#fc0752;">*&nbsp;</span>麻煩請簡單描述其他面試方式</p><textarea id="have13" rows="2" name="reother" v-model="vote" placeholder="其他沒提到的方式" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <br><br>
                                ...
                                <br>
                                <?php
                                                              if($po['experienceshare']!=''){
                                                                echo '
                                                                <textarea name="experienceshare" rows="2" style="width:100% ;height:100px; border-color:#7e7c7c; padding: 5px 10px;">'.$po['experienceshare'].'</textarea>
                                                                ';
                                                              }
                                                              else{
                                                                echo '
