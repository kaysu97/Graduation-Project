...
<body>
  ...
  $stmt = "UPDATE companyarticle SET CompanyNameSelected='$CompanyNameSelected', applydepartment='$applydepartment', interviewDate='$interviewDate', certification='$certification', Admitted='$Admitted', portfolio='$portfolio', portcontent='$portcontent', admitiontime='$admitiontime',
  certificationex='$certificationex', interview='$interview', interviewlevel='$interviewlevel',interviewerNumber='$interviewerNumber',intervieweeNumber='$intervieweeNumber',
  interviewDuration='$interviewDuration', dresscode='$dresscode', interviewQ1='$interviewQ1',interviewA1='$interviewA1',
  interviewQ2='$interviewQ2',interviewA2='$interviewA2',interviewQ3='$interviewQ3',interviewA3='$interviewA3',interviewQ4='$interviewQ4',interviewA4='$interviewA4',test='$test',testlevel='$testlevel',testDuration='$testDuration',testQType='$testQType',testexample1='$testexample1',testA1='$testA1',testexample2='$testexample2',testA2='$testA2',
  testexample3='$testexample3',testA3='$testA3',testexample4='$testexample4',testA4='$testA4',other='$other',reother='$reother',
  experienceshare='$experienceshare',uploadtime=now() WHERE id='$articleid'";
